...
function makeEmptyDay(dayIndex, carriedRosterSizes) {
...
async function startNewDay() {
  ...
  // Carry forward whatever roster sizes were in effect on the day that's
  // closing — so a correction SRSS made (e.g. a team's real headcount
  // changing mid-competition) persists into future days automatically,
  // instead of silently reverting to the original hardcoded defaults every
  // time a new day starts.
  const newDay = makeEmptyDay(newIndex, closingDay ? closingDay.rosterSizes : null);
